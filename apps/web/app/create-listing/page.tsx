  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await api.post('/items/create', {
        ...formData,
        pricePerDay: formData.type === 'Rent' ? parseInt(formData.pricePerDay) : undefined,
        ...
        <div className="card-neo bg-white p-10 w-full max-w-2xl">
          ...
          <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-6">
              ...
              {formData.type === 'Rent' && (
                <div>
                  <label className="block font-black uppercase text-sm mb-2 italic">Price (₹ per day)</label>
                  <input 
                    type="number" 
            ...
            <div className="space-y-6">
              <div>
                <label className="block font-black uppercase text-sm mb-2 italic">Photo URL</label>
              ...
              <div className="p-6 border-4 border-dashed border-black bg-gray-50 flex flex-col items-center justify-center text-center">
                 ...
                 <p className="text-[10px] font-bold text-gray-500 mb-4 italic">Auto-capture your current location for matching</p>
