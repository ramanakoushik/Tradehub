...
const ALL_LISTINGS = [
  { id: "1", title: "Digital Logic Design (Morris Mano)", price: 35000, category: "Books", type: "TRADE" as const, condition: "Like New", image: "https://loremflickr.com/800/600/book,technical" },
  { id: "2", title: "Casio fx-991ES Plus Scientific Calculator", price: 90000, category: "Electronics", type: "TRADE" as const, condition: "Good", image: "https://loremflickr.com/800/600/calculator,scientific" },
  { id: "3", title: "Drafting Board & Stand for EG", price: 120000, category: "Lab Gear", type: "TRADE" as const, condition: "Fair", image: "https://loremflickr.com/800/600/drafting,board" },
  { id: "4", title: "Presto Electric Kettle (1.5L)", price: 2500, category: "Electronics", type: "RENT" as const, condition: "New", isRental: true, image: "https://loremflickr.com/800/600/kettle,electric" },
  { id: "5", title: "RS Aggarwal Quantitative Aptitude", price: 20000, category: "Books", type: "TRADE" as const, condition: "Good", image: "https://loremflickr.com/800/600/textbook" },
  { id: "6", title: "Wireless Mouse & Keyboard Combo", price: 50000, category: "Electronics", type: "TRADE" as const, condition: "Excellent", image: "https://loremflickr.com/800/600/keyboard,mouse" },
  { id: "7", title: "Lab Coat (White, Large)", price: 25000, category: "Lab Gear", type: "TRADE" as const, condition: "Good", image: "https://loremflickr.com/800/600/labcoat" },
  { id: "8", title: "Study Table (Wooden)", price: 150000, category: "Furniture", type: "TRADE" as const, condition: "Fair", image: "https://loremflickr.com/800/600/desk,wooden" },
];
